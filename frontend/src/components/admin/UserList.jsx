...
const UserList = () => {
  ...
  const autoSearch = params.get("search"); // email or name
  ...
  useEffect(() => {
    if (autoSearch) {
      setSearchTerm(autoSearch.toLowerCase());
    }
    if (autoOpen === "true" && data?.users) {
      const foundUser = data.users.find(
        (u) =>
          u.email === autoSearch ||
          u.name.toLowerCase() === autoSearch.toLowerCase()
      );
